...
function initializeNavigation() {
    ...
    if (navbarToggler && navbarCollapse) {
        ...
        document.addEventListener('click', function(event) {
            ...
            const isTogglerClick = event.target.closest('.navbar-toggler');
...
function initializePerformanceOptimizations() {
    ...
    const criticalImages = [
        'assets/images/mainstreet-logo-optimized.svg',
        'assets/images/hero-analytics.jpg'
    ];
...
// Service Worker registration (disabled for static site)
// Uncomment and create sw.js file if you need offline functionality
/*
